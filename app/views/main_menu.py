...
class MainMenu(QFrame):
    ...
    def initialize_ui(self):
        ...
        if "cashier" in user_roles:
            self.selling_btn = ImageButton(image_path="app/res/icons/selling.png", image_size=50, button_text="Sell")
        ...
        if "admin" in user_roles:
            self.sales_btn = ImageButton(image_path="app/res/icons/sales.png", image_size=50, button_text="Sales")
            ...
            self.products_btn = ImageButton(image_path="app/res/icons/products.png", image_size=50, button_text="Products")
            ...
            self.users_btn = ImageButton(image_path="app/res/icons/users.png", image_size=50, button_text="Users")
        ...
        self.account_btn = ImageButton(image_path="app/res/icons/account.png", image_size=50, button_text="Account")
        ...
        self.logout_btn = ImageButton(image_path="app/res/icons/logout.png", image_size=50, button_text="Logout")
